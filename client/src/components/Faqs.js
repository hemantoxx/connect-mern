...
const faqs = [
  {
    ...
    text: 'ConnectLNM is a platform designed to bridge the gap between current students and alumni of institutes. It allows students to seek guidance and support from alumni who have expertise in various domains, helping them connect and learn from experienced professionals.',
  },
  {
    id: 2,
